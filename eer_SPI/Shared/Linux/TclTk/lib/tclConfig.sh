...
# installed.
TCL_PREFIX='/users/dor/afsr/005/eer_SPI/eer_SPI/TclTk/Linux'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/users/dor/afsr/005/eer_SPI/eer_SPI/TclTk/Linux'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/afsr/005/datac/Archive/tcl8.4.12/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/users/dor/afsr/005/eer_Tools/eer_SPI/TclTk//lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/users/dor/afsr/005/eer_SPI/eer_SPI/TclTk/Linux/include'
...
# compiled.
TCL_SRC_DIR='/home/afsr/005/datac/Archive/tcl8.4.12'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/users/dor/afsr/005/eeer_SPI/eer_SPI/TclTk/Linux/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/afsr/005/datac/Archive/tcl8.4.12/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/users/dor/afsr/005/eer_SPI/eer_SPI/TclTk/Linux/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/afsr/005/datac/Archive/tcl8.4.12/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/users/dor/afsr/005/eer_SPI/eer_SPI/TclTk/Linux/lib/libtclstub8.4${TCL_DBGX}.a'

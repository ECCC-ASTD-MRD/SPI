...
# String to pass to linker to pick up the Tclxml library from its
# installed directory.
Tclxml_LIB_SPEC='-L/users/dor/afsr/005/eer_SPI/eer_SPI/TclTk/Linux/lib/Tclxml3.1 -lTclxml3.1'
...
# String to pass to linker to pick up the Tclxml stub library from its
# installed directory.
Tclxml_STUB_LIB_SPEC='-L/users/dor/afsr/005/eer_SPI/eer_SPI/TclTk/Linux/lib/Tclxml3.1 -lTclxmlstub3.1'
...
# String to pass to linker to pick up the Tclxml stub library from its
# installed directory.
Tclxml_STUB_LIB_PATH='/users/dor/afsr/005/eer_SPI/eer_SPI/TclTk/Linux/lib/Tclxml3.1/libTclxmlstub3.1.a'

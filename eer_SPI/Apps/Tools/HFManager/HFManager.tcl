...
source $GDefs(Dir)/Apps/Tools/HFManager/HFManager.ctes
source $GDefs(Dir)/Apps/Tools/HFManager/HFManager.int
source $GDefs(Dir)/Apps/Tools/HFManager/HFManager.txt

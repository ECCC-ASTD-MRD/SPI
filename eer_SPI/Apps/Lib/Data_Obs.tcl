...
namespace eval Obs {
   ...
   set code [ catch {
      if { $GDefs(Lang)==0 } {
         metobs table -readmaster B $GDefs(Dir)/Lib/Data/table_b_bufr_f
         metobs table -readmaster D $GDefs(Dir)/Lib/Data/table_d_bufr_f
      } else {
         metobs table -readmaster B $GDefs(Dir)/Lib/Data/table_b_bufr_e
         metobs table -readmaster D $GDefs(Dir)/Lib/Data/table_d_bufr_e
      }
   } error ]

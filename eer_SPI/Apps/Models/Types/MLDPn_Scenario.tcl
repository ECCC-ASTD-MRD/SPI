...
proc MLDPn::ScenarioNew { Parent } {
   variable Sim

   switch $Sim(SrcType) {
      "volcano"  { MLDPn::ScenarioVolcanNew $Parent }
      "accident" { MLDPn::ScenarioAccidentNew $Parent }
      "virus"    { MLDPn::ScenarioVirusNew $Parent }
   }
}

#----------------------------------------------------------------------------
# Nom        : <MLDPn::ScenarioValidate>
...
proc MLDPn::ScenarioValidate { } {
   variable Sim

   if { ![MLDPn::ScenarioValidateName] } {
      return False
   }

   switch $Sim(SrcType) {
      "accident" {
         if { ![MLDPn::ValidateReleaseRatesAccident] } {
            return False
         }

         if { ![MLDPn::ValidateNbIsotopes] } {
            return False
         }

         if { ![MLDPn::ValidateDurationsRatesAccident] } {
            return False
         }

         MLDPn::ScenarioAccidentUpdateEmission

         if { ![MLDPn::ScenarioAccidentValidateTotalReleasedQuantity] } {
            return False
         }
         if { ![MLDPn::ValidateLullPeriodsStartAccident] } {
            return False
         }
         if { ![MLDPn::ValidateLullPeriodsEndAccident] } {
            return False
         }
      }
      "volcano"   {
         if { ![MLDPn::ValidateDurationsReleasesVolcano] } {
            return False
         }
         MLDPn::ScenarioVolcanUpdateEmission

         if { ![MLDPn::ValidateLullPeriodsStartVolcan] } {
            return False
         }
         if { ![MLDPn::ValidateLullPeriodsEndVolcan] } {
            return False
         }
      }
      "virus"    {
         if { ![MLDPn::ValidateReleaseRatesVirus] } {
            return False
         }
         if { ![MLDPn::ValidateDurationsRatesVirus] } {
            return False
         }

         MLDPn::ScenarioVirusUpdateEmission

         if { ![MLDPn::ScenarioVirusValidateTotalReleasedQuantity] } {
            return False
         }
         if { ![MLDPn::ValidateLullPeriodsStartVirus] } {
            return False
         }
         if { ![MLDPn::ValidateLullPeriodsEndVirus] } {
            return False
         }
      }
   }
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ScenarioValidateNameo>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ScenarioValidateName { } {
   global GDefs
   variable Tmp
   variable Error
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ScenarioValidateDurations>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ScenarioValidateDurations { } {
   variable Sim
   variable Tmp

   for { set i 0 } { $i < $Sim(EmMaxInterval) } { incr i } {
      if { ![MLDPn::ValidateDurationValue $Tmp(Duration$i) $Parent $i] } {
         focus $MLDPn::Sim(ReleaseRatesFrame).entry$i.dur
         return False
      }
   }
   return True
...
proc MLDPn::ScenarioAccidentNew { Parent } {
   global GDefs
   variable Sim
   variable Tmp
   variable Msg
   ...
   wm title     .newscenario "MLDPn: $Exp::Data(Name) - [lindex $Lbl(Scenario) $GDefs(Lang)]"
   ...
   frame .newscenario.emint.fr.box1.data.name
      ...
      entry .newscenario.emint.fr.box1.data.name.ent -relief sunken -bd 1 -bg $GDefs(ColorLight) -textvariable MLDPn::Tmp(Scenario) -width 20
   ...
   set MLDPn::Sim(ScenarioNameEntry) .newscenario.emint.fr.box1.data.name.ent
   ...
   frame .newscenario.emint.fr.box1.data.totdur
      ...
      entry .newscenario.emint.fr.box1.data.totdur.ent -relief sunken -bd 1 -textvariable MLDPn::Tmp(TotalDuration) -width 20 -state disabled
   ...
   frame .newscenario.emint.fr.box1.data.effdur
      ...
      entry .newscenario.emint.fr.box1.data.effdur.ent -relief sunken -bd 1 -textvariable MLDPn::Tmp(EffectiveDuration) -width 20 -state disabled
   ...
   set MLDPn::Sim(ReleaseRatesFrame) .newscenario.emint.fr.box2
   ...
   frame .newscenario.emint.fr.box2.header
      ...
      frame .newscenario.emint.fr.box2.header.rates
         ...
         button .newscenario.emint.fr.box2.header.rates.add -text "[lindex $Lbl(Add) $GDefs(Lang)]" -relief raised -bd 1 -width 10 -state active \
            -command "IsoBox::Create .newscenario MLDPn::SpeciesFormat"
         ...
         set MLDPn::Sim(IsotopeLabels) .newscenario.emint.fr.box2.header.rates.iso
         for { set j 0 } { $j < $Sim(EmMaxIso) } { incr j } {
            button .newscenario.emint.fr.box2.header.rates.iso.name$j -relief raised -width 11 -bd 1 -textvariable MLDPn::Tmp(Iso$j) \
               -command "MLDPn::SpeciesDelete $j"
   ...
   for { set i 0 } { $i < $Sim(EmMaxInterval) } { incr i } {
      ...
      frame .newscenario.emint.fr.box2.entry$i
         entry .newscenario.emint.fr.box2.entry$i.dur -relief sunken -width 20 -bd 1 -bg $GDefs(ColorLight) -textvariable MLDPn::Tmp(Duration$i)
      ...
      frame .newscenario.emint.fr.box2.entry$i.rates
         for { set j 0 } { $j < $Sim(EmMaxIso) } { incr j } {
            entry .newscenario.emint.fr.box2.entry$i.rates.iso$j -relief sunken -width 15 -bd 1 -bg $GDefs(ColorLight) -textvariable MLDPn::Tmp(ReleaseRate$i.$j)
   ...
   frame .newscenario.emint.fr.box2.quant -relief raised -bd 1
      ...
      for { set j 0 } { $j < $Sim(EmMaxIso) } { incr j } {
         entry .newscenario.emint.fr.box2.quant.tot.iso$j -relief sunken -width 15 -bd 1 -textvariable MLDPn::Tmp(ReleaseQuantity$j) -state disabled
   ...
   frame .newscenario.button
      ...
      button .newscenario.button.apply -text "[lindex $Lbl(Apply) $GDefs(Lang)]" -bd 1 -command "MLDPn::EmissionUpdate"
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ScenarioAccidentInit>
# Creation   : 25 February 2003 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ScenarioAccidentInit { } {
   variable Tmp
   variable Sim
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ScenarioAccidentUpdateTotalQuantity>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ScenarioAccidentUpdateEmission { } {
   variable Sim
   variable Tmp
   variable Quant
...
proc MLDPn::ScenarioVirusNew { Parent } {
   global GDefs
   variable Sim
   variable Tmp
   variable Msg
   ...
   for { set i 0 } { $i < $Sim(EmMaxInterval) } { incr i } {
       ...
       frame .newscenario.emint.fr.box2.entry$i
          ...
          entry .newscenario.emint.fr.box2.entry$i.rates -relief sunken -width 20 -bd 1 -bg $GDefs(ColorLight) -textvariable MLDPn::Tmp(ReleaseRate$i)
   ...
   frame .newscenario.emint.fr.box2.quant -relief raised -bd 1
      ...
      entry .newscenario.emint.fr.box2.quant.tot -relief sunken -width 30 -bd 1 -textvariable MLDPn::Tmp(ReleaseQuantity) -state disabled
      pack .newscenario.emint.fr.box2.quant.tot -side left -fill y
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ScenarioVirusUpdateEmission>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
# But        : Update (total and effective) emission durations and
#              total released quantity.
...
proc MLDPn::ScenarioVirusUpdateEmission { } {
   variable Sim
   variable Tmp
...
proc MLDPn::ScenarioVolcanNew { Parent } {
   global GDefs
   variable Sim
   variable Tmp
   variable Msg
   ...
   frame .newscenario.emint.fr.box1.data.name
      label .newscenario.emint.fr.box1.data.name.lbl -relief flat -anchor w -text "[lindex $Lbl(ScenarioName) $GDefs(Lang)]"
      entry .newscenario.emint.fr.box1.data.name.ent -relief sunken -bd 1 -bg $GDefs(ColorLight) -textvariable MLDPn::Tmp(Scenario) -width 60
      pack .newscenario.emint.fr.box1.data.name.lbl .newscenario.emint.fr.box1.data.name.ent -side left -padx 2
   pack .newscenario.emint.fr.box1.data.name -side top -anchor w -padx 2 -fill x
   Bubble::Create .newscenario.emint.fr.box1.data.name $Bubble(ScenarioName)
   set MLDPn::Sim(ScenarioNameEntry) .newscenario.emint.fr.box1.data.name.ent
   ...
   frame .newscenario.emint.fr.box1.data.totdur
      label .newscenario.emint.fr.box1.data.totdur.lbl -relief flat -anchor w -text "[lindex $Lbl(TotalDuration) $GDefs(Lang)]"
      entry .newscenario.emint.fr.box1.data.totdur.ent -relief sunken -bd 1 -textvariable MLDPn::Tmp(TotalDuration) -width 60 -state disabled
      pack .newscenario.emint.fr.box1.data.totdur.lbl .newscenario.emint.fr.box1.data.totdur.ent -side left -padx 2
   pack .newscenario.emint.fr.box1.data.totdur -side top -anchor w -padx 2 -fill x
   ...
   frame .newscenario.emint.fr.box1.data.effdur
      label .newscenario.emint.fr.box1.data.effdur.lbl -relief flat -anchor w -text "[lindex $Lbl(EffectiveDuration) $GDefs(Lang)]"
      entry .newscenario.emint.fr.box1.data.effdur.ent -relief sunken -bd 1 -textvariable MLDPn::Tmp(EffectiveDuration) -width 60 -state disabled
      pack .newscenario.emint.fr.box1.data.effdur.lbl .newscenario.emint.fr.box1.data.effdur.ent -side left -padx 2
   pack .newscenario.emint.fr.box1.data.effdur -side top -anchor w -padx 2 -fill x
   ...
   for { set i 0 } { $i < $Sim(EmMaxInterval) } { incr i } {
      ...
      frame .newscenario.emint.fr.box2.entry$i
         ...
         Option::Create .newscenario.emint.fr.box2.entry$i.em "" [list MLDPn::Tmp(Label$i) MLDPn::Tmp(Value$i)] \
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ScenarioVolcanUpdateEmission>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ScenarioVolcanUpdateEmission { } {
   variable Tmp
   variable Sim
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ScenarioAccidentValidateTotalReleasedQuantity>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ScenarioAccidentValidateTotalReleasedQuantity { } {
   global   GDefs
   variable Sim
   variable Error
   variable Tmp
      ...
      if { $Tmp(ReleaseQuantity$j) == 0 } {
         ...
         for { set i 0 } { $i < $Sim(EmMaxInterval) } { incr i } {
            if { $Tmp(ReleaseRate$i.$j) == 0 } {
               ...
               focus $MLDPn::Sim(ReleaseRatesFrame).entry$i.rates.iso$j
               return False
            }
         }
      }
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ScenarioVirusValidateTotalReleasedQuantity>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ScenarioVirusValidateTotalReleasedQuantity { } {
   global   GDefs
   variable Sim
   variable Error
   variable Tmp
   ...
   if { $Tmp(ReleaseQuantity) == 0 } {
      ...
      for { set i 0 } { $i < $Sim(EmMaxInterval) } { incr i } {
         if { $Tmp(ReleaseRate$i) == 0 } {
            ...
            focus $MLDPn::Sim(ReleaseRatesFrame).entry$i.rates
            return False
         }
      }
   }
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateDurationValue>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ValidateDurationValue { Duration Parent { Idx -1 } } {
   global GDefs
   variable Sim
   variable Error
   variable Tmp
   ...
   set timestepsec [expr $MLDPn::Sim(ModelTimeStepMin)*60]
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateDurationsRatesAccident>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ValidateDurationsRatesAccident { } {
   global   GDefs
   variable Sim
   variable Tmp
   variable Error
   ...
   for { set j 0 } { $j < [llength $Tmp(Iso)] } { incr j } {
      if { !$hasFoundDuration && !$hasFoundRate($j) } {
         ...
         Dialog::Error .newscenario $Error(Scenario)
         focus $MLDPn::Sim(ReleaseRatesFrame).entry0.dur
         return 0
      }
   }
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateDurationsRatesVirus>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
# But        : Verify if emission durations and release rate fields
#              are filled simultaneously. Verify if there is no empty
...
proc MLDPn::ValidateDurationsRatesVirus { } {
   global   GDefs
   variable Sim
   variable Tmp
   variable Error
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateDurationsReleasesVolcano>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ValidateDurationsReleasesVolcano { } {
   global   GDefs
   variable Sim
   variable Tmp
   variable Error
...
proc MLDPn::ValidateDurationsVsModelTimeStep { } {
   ...
   foreach interval $Sim(EmInter.$Sim(EmScenario)) {
      ...
      if { ![MLDPn::ValidateDurationValue $duration .modelnew] } {
         return 0
      }
   }
   return 1
...
proc MLDPn::ValidateNbIsotopes { } {
   ...
   if { [llength $Tmp(Iso)] < 1 } {
      ...
      for { set i 0 } { $i < $Sim(EmMaxInterval) } { incr i } {
         if { $Tmp(Duration$i) != "" } {
            focus $MLDPn::Sim(ReleaseRatesFrame).entry$i.rates.iso0
            return 0
         }
      }
      focus $MLDPn::Sim(ReleaseRatesFrame).entry0.rates.iso0
      return 0
   }
   return 1
}
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateReleaseRatesAccident>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ValidateReleaseRatesAccident { } {
   variable Sim
   variable Tmp
   ...
   for { set i 0 } { $i < $Sim(EmMaxInterval) } { incr i } {
      for { set j 0 } { $j < [llength $Tmp(Iso)] } { incr j } {
         ...
         if { [MLDPn::ValidateReleaseRateValue $i $j] } {
            if { $Tmp(ReleaseRate$i.$j) != "" } {
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateReleaseRatesVirus>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ValidateReleaseRatesVirus { } {
   variable Sim
   variable Tmp
   ...
   for { set i 0 } { $i < $Sim(EmMaxInterval) } { incr i } {
      ...
      if { [MLDPn::ValidateReleaseRateValue $i] } {
         if { $Tmp(ReleaseRate$i) != "" } {
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateReleaseRateValue>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ValidateReleaseRateValue { Interval { Isotope -1 } } {
   global GDefs
   variable Tmp
   variable Error
...
#
# But        : Validate model time step according to grid scale for MLDPn1
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateLullPeriodsEndAccident>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ValidateLullPeriodsEndAccident { } {
   global   GDefs
   variable Sim
   variable Error
   variable Tmp
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateLullPeriodsEndVirus>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
# But        : Validate lull periods at the end of the release scenario
#              for virus source type.
...
proc MLDPn::ValidateLullPeriodsEndVirus { } {
   global   GDefs
   variable Sim
   variable Error
   variable Tmp
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateLullPeriodsEndVolcan>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
# But        : Validate lull periods at the end of the release scenario
...
proc MLDPn::ValidateLullPeriodsEndVolcan { } {
   global   GDefs
   variable Sim
   variable Error
   variable Tmp
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateLullPeriodsStartAccident>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
...
proc MLDPn::ValidateLullPeriodsStartAccident { } {
   global   GDefs
   variable Sim
   variable Error
   variable Tmp
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateLullPeriodsStartVirus>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
# But        : Validate lull periods at the beginning of the release
...
proc MLDPn::ValidateLullPeriodsStartVirus { } {
   global   GDefs
   variable Sim
   variable Error
   variable Tmp
...
#----------------------------------------------------------------------------
# Nom        : <MLDPn::ValidateLullPeriodsStartVolcan>
# Creation   : 22 March 2004 - A. Malo - CMC/CMOE
#
# But        : Validate lull periods at the beginning of the release
...
proc MLDPn::ValidateLullPeriodsStartVolcan { } {
   global   GDefs
   variable Sim
   variable Error
   variable Tmp

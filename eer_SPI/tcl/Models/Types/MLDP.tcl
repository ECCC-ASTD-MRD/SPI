...
source $GDefs(Dir)/tcl/Models/Types/MLDP.txt
source $GDefs(Dir)/tcl/Models/Types/MLDP.ctes
source $GDefs(Dir)/tcl/Models/Types/MLDP.int
source $GDefs(Dir)/tcl/Models/Types/MLDP_Scenario.tcl

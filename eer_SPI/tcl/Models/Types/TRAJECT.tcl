...
source $GDefs(Dir)/tcl/Models/Types/TRAJECT.ctes
source $GDefs(Dir)/tcl/Models/Types/TRAJECT.txt
source $GDefs(Dir)/tcl/Models/Types/TRAJECT.int
...
proc TRAJECT::Launch { } {
   ...
   if { $Model::Param(IsUsingSoumet) } {
      ...
      eval set tid1 \[thread::create -stack 1073741824 \{ load $GDefs(Dir)/Lib/$env(BASE_ARCH)/libTclSim[info sharedlibextension] TclSim\; simulation run $id\}\]

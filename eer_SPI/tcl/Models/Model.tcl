...
source $GDefs(Dir)/tcl/Models/Meteo.tcl
source $GDefs(Dir)/tcl/Models/Exp.tcl
source $GDefs(Dir)/tcl/Models/Watch.tcl

#----- Inclure les types de modeles
source $GDefs(Dir)/tcl/Models/Types/TRAJECT.tcl
source $GDefs(Dir)/tcl/Models/Types/SATDATA.tcl
source $GDefs(Dir)/tcl/Models/Types/MLCD.tcl
source $GDefs(Dir)/tcl/Models/Types/MLDP.tcl
source $GDefs(Dir)/tcl/Models/Types/MLDPn.tcl
...
proc Model::ParamsGridDefine { Model { Mode NEW } } {
   ...
   if { $Mode!="NEW" } {
      ...
      fstdfield define MODELGRID -GRTYP [string index [lindex $sim(Grid) 6]] [lindex $sim(Grid) 2] [lindex $sim(Grid) 3] [lindex $sim(Grid) 4] [lindex $sim(Grid) 5]

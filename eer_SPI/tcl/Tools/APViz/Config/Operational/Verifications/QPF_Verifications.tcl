...
set Params(PR) "-colormap REC_Rainbow -color black -value INTEGER 0 -font XFont12 -width 2 -rendercontour 0 -rendertexture 1 -rendervalue 20 -mapall True -intervals \{ 1 5 10 15 20 30 40 50 75 100 125 150 200 \} -factor 1e3"
set Params(13023) "-size 10 -icon CIRCLE -color black -colormap REC_Rainbow -mapall True -rendertexture 1 -rendercontour 1 -rendervalue 1 -font XFont12 -intervals \{ 1 5 10 15 20 30 40 50 75 100 125 150 200 \}"
set Params(13193) "-size 10 -icon CIRCLE -color black -colormap REC_Rainbow -mapall True -rendertexture 1 -rendercontour 1 -rendervalue 1 -font XFont12 -intervals \{ 1 5 10 15 20 30 40 50 75 100 125 150 200 \}"

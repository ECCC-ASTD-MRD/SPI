...
source $GDefs(Dir)/tcl/Tools/SatData/SatData.ctes
source $GDefs(Dir)/tcl/Tools/SatData/SatData.txt
source $GDefs(Dir)/tcl/Tools/SatData/SatData.int
...
proc SatData::UpdateItems { Frame } {
   ...
   if { $Frame==$Data(Frame) } {
      ...
      if { $Data(ViewGOES15) } {
         Viewport::DrawArea $Data(Frame) $Data(VP) $Data(CoordGOES15) "PAGE$Data(VP) SAT" SATGOES15 \
            blue blue @$GDefs(Dir)/share/bitmap/raydiagright08.xbm False 1
      }
      if { $Data(ViewGOES13) } {
         Viewport::DrawArea $Data(Frame) $Data(VP) $Data(CoordGOES13) "PAGE$Data(VP) SAT" SATGOES13 \

...
source $GDefs(Dir)/tcl/Tools/NowCaster/NowCaster.ctes
source $GDefs(Dir)/tcl/Tools/NowCaster/NowCaster.txt
source $GDefs(Dir)/tcl/Tools/NowCaster/NowCaster.int

#----- Lire les types de donnees

foreach type [lsort [glob $GDefs(Dir)/tcl/Tools/NowCaster/Types/*.tcl]] {

...
proc Macro::ModelQuebec::Execute { } {
   ...
   model read Ground    $env(GEO_PATH)/3DModel/Quebec/terrain.mdl
   model read Building1 $env(GEO_PATH)/3DModel/Quebec/public.mdl
   model read Building2 $env(GEO_PATH)/3DModel/Quebec/maison.mdl
   model read Building3 $env(GEO_PATH)/3DModel/Quebec/mur.mdl
   ...
   model read Helico $env(GEO_PATH)/3DModel/Quebec/hughe500.mdl
   model read F18    $env(GEO_PATH)/3DModel/Quebec/F18.mdl
   model read 747    $env(GEO_PATH)/3DModel/Quebec/747.mdl
   ...
   model read 911 $env(GEO_PATH)/3DModel/Quebec/747.mdl
   model matrix 911 -locate 46.80794262 -71.217946 175
   model matrix 911 -rotate 70.0 0.0 0.0
   model matrix 911 -scale 0.3 0.3 0.3

#   model read TST3DS $env(GEO_PATH)/3DModel/breguet/breguet.3DS
#   model read TST3DS $env(GEO_PATH)/3DModel/Semi/a3dsemi.3ds

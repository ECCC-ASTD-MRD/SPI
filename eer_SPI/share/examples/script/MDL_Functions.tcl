...
set models [glob -tails -directory $env(GEO_PATH)/Vector/Cities/Montreal/CityGML_LOD2_20140115 *.gml]
foreach model $models  {
   puts "   Reading $model"
   model read $model "$env(GEO_PATH)/Vector/Cities/Montreal/CityGML_LOD2_20140115/$model"

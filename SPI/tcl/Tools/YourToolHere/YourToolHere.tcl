...
source $GDefs(Dir)/tcl/Tools/YourToolHere/YourToolHere.ctes
source $GDefs(Dir)/tcl/Tools/YourToolHere/YourToolHere.txt
source $GDefs(Dir)/tcl/Tools/YourToolHere/YourToolHere.int

      ...
      frame $Data(Frame).def.l
        ...
        labelframe $Data(Frame).def.l.val -text [lindex $Lbl(Data) $GDefs(Lang)]
            ...
            frame $Data(Frame).def.l.val.mod
               ...
               bind $Data(Frame).def.l.val.mod.fac <Any-KeyRelease> {if { [string length $FSTD::Param(TopoFac)] && [string is double $FSTD::Param(TopoFac)] } FSTD::ParamSet}
            frame $Data(Frame).def.l.val.fac
               ...
               bind $Data(Frame).def.l.val.fac.seld <Any-KeyRelease> {if { [string length $FSTD::Param(Delta)] && [string is double $FSTD::Param(Delta)] } FSTD::ParamSet}
               bind $Data(Frame).def.l.val.fac.self <Any-KeyRelease> {if { [string length $FSTD::Param(Factor)] && [string is double $FSTD::Param(Factor)] } FSTD::ParamSet}

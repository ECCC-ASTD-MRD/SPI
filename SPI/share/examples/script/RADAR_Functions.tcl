...
#----- Open the radar file
set scans [radarfile open RADARSITE read $env(CI_DATA_IN)/200803121320~~CONVOL:URP:XFT:RADAR:IRIS]
...
radarscan stats SCAN1 -levelindex 0
puts "\n   Radar sweep angle 0"
...
radarscan stats SCAN1 -levelindex 12

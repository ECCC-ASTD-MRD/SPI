...
set f [open $env(CI_DATA_IN)/MWO.reg]

#----- Creation du fichier
catch { file delete $env(CI_DATA_OUT)/OGR_Create.shp }
ogrfile open FILE write $env(CI_DATA_OUT)/OGR_Create.shp "ESRI Shapefile"

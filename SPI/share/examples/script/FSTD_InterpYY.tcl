...
catch { file delete $env(CI_DATA_OUT)/FSTD_InterpYY.fstd }

fstdfile open 1 read $env(CI_DATA_IN)/AreaEms.YinYang.fst
fstdfile open 2 read $env(CI_DATA_IN)/AreaEms.LatLon.fst
fstdfile open 3 write $env(CI_DATA_OUT)/FSTD_InterpYY.fstd

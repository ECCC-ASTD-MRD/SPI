...
#set fields [gribfile open GRIBIN read $env(CI_DATA_IN)/CMC_reg_4LFTX_SFC_0_ps15km_2010122000_P000.grib2]
#set fields [gribfile open GRIBIN read $env(CI_DATA_IN)/CMC_glb_ALBDO_SFC_0_latlon.6x.6_2011012000_P018.grib2]
set fields [gribfile open GRIBIN read $env(CI_DATA_IN)/CMC_reg_ABSV_ISBL_250_ps15km_2011012100_P000.grib]
...
fstdfile open FSTDIN read $env(CI_DATA_IN)/2005120600_012
...
gribfile open GRIBOUT write $env(CI_DATA_OUT)/GRIB_Funcs.grib

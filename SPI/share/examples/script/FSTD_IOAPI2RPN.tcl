...
file delete $env(CI_DATA_OUT)/FSTD_IOAPI2RPN.fstd

#----- Ouvrir les fichiers d'entree (1) sortie (2)
fstdfile open OUT write $env(CI_DATA_OUT)/FSTD_IOAPI2RPN.fstd
...
foreach band [gdalfile open IN read $env(CI_DATA_IN)/egts_s.20101212.1.12US1.aqmeii2.ncf] {

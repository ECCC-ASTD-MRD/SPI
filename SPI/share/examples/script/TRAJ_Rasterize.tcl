...
file delete $env(CI_DATA_OUT)/TRAJ_Rasterize.fstd DataOut/TRAJ_Rasterize.shp

#----- We have to create an OGR object. this is done by transforming to shapefile
ogrfile open FILE write $env(CI_DATA_OUT)/TRAJ_Rasterize.shp "ESRI Shapefile"
...
set layer [ogrfile open FILE append $env(CI_DATA_OUT)/TRAJ_Rasterize.shp]
...
fstdfile open RESULTFILE write $env(CI_DATA_OUT)/TRAJ_Rasterize.fstd

...
catch { file delete DataOut/FSTD_InterpPrecip.fstd }

fstdfile open YY  read DataIn/YY.fstd
fstdfile open LL  read DataIn/LL.fstd
fstdfile open OUT write DataOut/FSTD_InterpPrecip.fstd

fstdfield read TO LL -1 "" -1 -1 -1 "" "P0"
fstdfield stats TO -nodata 0.0

set f [open DataOut/FSTD_InterpPrecip.idx w]
#set f [open DataOut/FSTD_InterpPrecip.idx r]

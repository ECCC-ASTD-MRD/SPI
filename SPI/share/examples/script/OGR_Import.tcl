...
fstdfile open FSTDFILE read $env(CI_SPI_IN)/2005102612_012
...
catch { file delete $env(CI_SPI_OUT)/OGR_Import.shp }
...
ogrfile open OGRFILE write $env(CI_SPI_OUT)/OGR_Import.shp "ESRI Shapefile"

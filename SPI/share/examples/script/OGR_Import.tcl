...
fstdfile open FSTDFILE read $env(CI_DATA_IN)/2005102612_012
...
catch { file delete $env(CI_DATA_OUT)/OGR_Import.shp }
...
ogrfile open OGRFILE write $env(CI_DATA_OUT)/OGR_Import.shp "ESRI Shapefile"

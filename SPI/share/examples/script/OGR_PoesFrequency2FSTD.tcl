...
file delete -force $env(CI_DATA_OUT)/OGR_POESFrequency2FSTD.fstd

#----- Open the files
fstdfile open FSTDOUT write $env(CI_DATA_OUT)/OGR_POESFrequency2FSTD.fstd
ogrfile open VECFILE read $env(CI_DATA_IN)/POES_edm.shp

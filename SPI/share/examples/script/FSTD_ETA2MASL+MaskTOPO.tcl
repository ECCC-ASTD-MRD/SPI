...
catch { file delete $env(CI_DATA_OUT)/FSTD_ETA2MASL_MaskTOPO.fstd }

#----- Open RPN in/out files
fstdfile open IN read $env(CI_DATA_IN)/m2009030112_009
fstdfile open OUT write $env(CI_DATA_OUT)/FSTD_ETA2MASL_MaskTOPO.fstd

...
bufrtemplate create TEMPLATE $env(CI_DATA_IN)/OBS_BUFREncode.template
...
catch { file delete -force $env(CI_DATA_OUT)/OBS_BUFREncode.bufr $env(CI_DATA_OUT)/OBS_BUFREncode.txt }
bufrdataset write DATASET $env(CI_DATA_OUT)/OBS_BUFREncode.bufr BUFR
bufrdataset write DATASET $env(CI_DATA_OUT)/OBS_BUFREncode.txt ASCII

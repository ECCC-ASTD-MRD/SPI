...
set Data(Path) $env(CI_DATA_IN)/10101214.ASC
set Data(Nb)   0

#----- Create the shapefile
catch { file delete $env(CI_DATA_OUT)/OGR_ASC2SHP.shp }
ogrfile open SHAPEFILE write $env(CI_DATA_OUT)/OGR_ASC2SHP.shp "ESRI Shapefile"

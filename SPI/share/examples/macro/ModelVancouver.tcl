...
proc Macro::ModelVancouver::Execute { } {
   ...
   model read VANC3D $env(GEO_PATH)/3DModel/Vancouver/CRTI_Vanc_Mod_Final5_Apr16_BLDG_ONLY.flt
   model define VANC3D -georef VANREF
   Mapper::UpdateData $Page::Data(Frame) VANC3D

   Macro::Doing "Reading 10cm imagery"
   Mapper::Read $env(GEO_PATH)/3DModel/Vancouver/Images_10cm/Vancouver_10cm.tif

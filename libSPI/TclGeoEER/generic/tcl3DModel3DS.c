   ...
   while (PreviousChunk->bytes<PreviousChunk->length) {
      ...
      switch (currentChunk.ID) {
         ...
         case VERSION: // This holds the version of the file
            App_Log(APP_DEBUG,"%s: Model3DS_ChunkProcessNext: VERSION\n",__func__);
            ...
            if ((currentChunk.length-currentChunk.bytes==4)) {
               ...
               if (ver>0x03) {
                  App_Log(APP_WARNING,"%s: This 3DS file is over version 3 so it may load incorrectly",__func__);
               }
            } else {
         ...
         case OBJECTINFO: // This holds the version of the mesh
            App_Log(APP_DEBUG,"%s: OBJECTINFO\n",__func__);
         ...
         case EDITKEYFRAME:
            App_Log(APP_DEBUG,"%s: EDITKEYFRAME\n",__func__);
   ...
   while (PreviousChunk->bytes<PreviousChunk->length) {
      ...
      switch (currentChunk.ID) {
         ...
         case OBJECT_MESH: // This lets us know that we are reading a new object
            App_Log(APP_DEBUG,"%s: OBJECT_MESH\n",__func__);
      ...
      switch (currentChunk.ID) {
         ...
         case MATDIFFUSE: // This holds the R G B color of our object
          ...
          case MATSPECULAR: // This holds the R G B color of our object
            App_Log(APP_DEBUG,"%s: MATSPECULAR\n",__func__);
         ...
         case MATMAPFILE: // This stores the file name of the material
            App_Log(APP_DEBUG,"%s: MATMAPFILE\n",__func__);

...
#if defined(_FLOAT0) ||  defined(_FLOAT1) ||  defined(_FLOAT2)
#define NEC
#define f77name(x) x##_
#if defined (_FLOAT2)
...
#if defined(_FLOAT0) || defined(Alpha)
#    define INT_32 int
#    define INT_64 long
#else
#    define INT_32 long
...
#if defined(HP) || defined (SUN) || defined (i386) || defined(Alpha) || (defined (SGI) && !defined (F77_O32))

...
#   #----- Launch RSMC meteorological fields script.
#   set ErrorCode [catch { exec $Sim(MetfieldsScript) $Sim(LocalTmpDir) $Sim(SimDateTime) $Sim(SimDateTime) >& $Sim(MetfieldsOutFile) & } Message]

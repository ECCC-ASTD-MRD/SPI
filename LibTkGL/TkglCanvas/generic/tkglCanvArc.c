...
static int         StyleParseProc(ClientData clientData,Tcl_Interp *interp,Tk_Window tkwin,CONST const char *value,char *widgRec,int offset);
static const char *StylePrintProc(ClientData clientData,Tk_Window tkwin,char *widgRec,int offset,Tcl_FreeProc **freeProcPtr);
...
static const Tk_CustomOption styleOption  = { StyleParseProc,StylePrintProc,NULL };
...
static Tk_ConfigSpec configSpecs[] = {
   { TK_CONFIG_CUSTOM, "-activedash", NULL, NULL, NULL, Tk_Offset(glArcItem, outline.activeDash), TK_CONFIG_NULL_OK, &dashOption },
   { TK_CONFIG_COLOR, "-activefill", NULL, NULL, NULL, Tk_Offset(glArcItem, activeFillColor), TK_CONFIG_NULL_OK },
   { TK_CONFIG_COLOR, "-activeoutline", NULL, NULL, NULL, Tk_Offset(glArcItem, outline.activeColor), TK_CONFIG_NULL_OK },
   { TK_CONFIG_BITMAP, "-activeoutlinestipple", NULL, NULL, NULL, Tk_Offset(glArcItem, outline.activeStipple), TK_CONFIG_NULL_OK },
   { TK_CONFIG_CUSTOM,"-activestipple", NULL, NULL, NULL, Tk_Offset(glArcItem,activeFillStipple),TK_CONFIG_NULL_OK,&bitmapOption },
   { TK_CONFIG_CUSTOM, "-activewidth", NULL, NULL, "0.0", Tk_Offset(glArcItem, outline.activeWidth), TK_CONFIG_DONT_SET_DEFAULT, &pixelOption },
   { TK_CONFIG_CUSTOM, "-dash", NULL, NULL, NULL, Tk_Offset(glArcItem, outline.dash), TK_CONFIG_NULL_OK, &dashOption },
   { TK_CONFIG_PIXELS, "-dashoffset", NULL, NULL, "0", Tk_Offset(glArcItem, outline.offset), TK_CONFIG_DONT_SET_DEFAULT },
   { TK_CONFIG_CUSTOM, "-disableddash", NULL, NULL, NULL, Tk_Offset(glArcItem, outline.disabledDash), TK_CONFIG_NULL_OK, &dashOption },
   { TK_CONFIG_COLOR, "-disabledfill", NULL, NULL, NULL, Tk_Offset(glArcItem, disabledFillColor), TK_CONFIG_NULL_OK },
   { TK_CONFIG_COLOR, "-disabledoutline", NULL, NULL, NULL, Tk_Offset(glArcItem, outline.disabledColor), TK_CONFIG_NULL_OK },
   { TK_CONFIG_BITMAP, "-disabledoutlinestipple", NULL, NULL, NULL, Tk_Offset(glArcItem, outline.disabledStipple), TK_CONFIG_NULL_OK },
   { TK_CONFIG_CUSTOM,"-disabledstipple", NULL, NULL, NULL, Tk_Offset(glArcItem,disabledFillStipple),TK_CONFIG_NULL_OK,&bitmapOption },
   { TK_CONFIG_CUSTOM, "-disabledwidth", NULL, NULL, "0.0", Tk_Offset(glArcItem, outline.disabledWidth), TK_CONFIG_DONT_SET_DEFAULT, &pixelOption },
   { TK_CONFIG_DOUBLE, "-extent", NULL, NULL, "90", Tk_Offset(glArcItem, extent), TK_CONFIG_DONT_SET_DEFAULT },
   { TK_CONFIG_COLOR, "-fill", NULL, NULL, NULL, Tk_Offset(glArcItem, fillColor), TK_CONFIG_NULL_OK },
   { TK_CONFIG_CUSTOM, "-offset", NULL, NULL, "0,0", Tk_Offset(glArcItem, tsoffset), TK_CONFIG_DONT_SET_DEFAULT, &offsetOption },
   { TK_CONFIG_COLOR, "-outline", NULL, NULL, "black", Tk_Offset(glArcItem, outline.color), TK_CONFIG_NULL_OK },
   { TK_CONFIG_CUSTOM, "-outlineoffset", NULL, NULL, "0,0", Tk_Offset(glArcItem, outline.tsoffset), TK_CONFIG_DONT_SET_DEFAULT, &offsetOption },
   { TK_CONFIG_BITMAP, "-outlinestipple", NULL, NULL, NULL, Tk_Offset(glArcItem, outline.stipple), TK_CONFIG_NULL_OK },
   { TK_CONFIG_DOUBLE, "-start", NULL, NULL, "0", Tk_Offset(glArcItem, start), TK_CONFIG_DONT_SET_DEFAULT },
   { TK_CONFIG_CUSTOM, "-state", NULL, NULL, NULL, Tk_Offset(Tk_Item, state), TK_CONFIG_NULL_OK, &stateOption },
   { TK_CONFIG_CUSTOM,"-stipple", NULL, NULL, NULL, Tk_Offset(glArcItem,fillStipple),TK_CONFIG_NULL_OK,&bitmapOption },
   { TK_CONFIG_CUSTOM, "-style", NULL, NULL, NULL, Tk_Offset(glArcItem, style), TK_CONFIG_DONT_SET_DEFAULT, &styleOption },
   { TK_CONFIG_CUSTOM, "-tags", NULL, NULL,  NULL, 0, TK_CONFIG_NULL_OK, &tagsOption },
   { TK_CONFIG_CUSTOM, "-width", NULL, NULL, "1.0", Tk_Offset(glArcItem, outline.width), TK_CONFIG_DONT_SET_DEFAULT, &pixelOption },
   { TK_CONFIG_INT, "-transparency", NULL, NULL, "100", Tk_Offset(glArcItem,alpha), TK_CONFIG_DONT_SET_DEFAULT},
   { TK_CONFIG_END, NULL, NULL, NULL, NULL, 0, 0}
};

/* Prototypes for procedures defined in this file */

static void   glComputeArcBbox(Tk_Canvas canvas,glArcItem *arcPtr);
static int    glConfigureArc(Tcl_Interp *interp,Tk_Canvas canvas,Tk_Item *itemPtr,int objc,Tcl_Obj *CONST objv[],int flags);
static int    glCreateArc(Tcl_Interp *interp,Tk_Canvas canvas,struct Tk_Item *itemPtr,int objc,Tcl_Obj *CONST objv[]);
static void   glDeleteArc(Tk_Canvas canvas,Tk_Item *itemPtr,Display *display);
static void   glDisplayArc(Tk_Canvas canvas,Tk_Item *itemPtr,Display *display,Drawable dst,int x,int y,int width,int height);
static int    glArcCoords(Tcl_Interp *interp,Tk_Canvas canvas,Tk_Item *itemPtr,int objc,Tcl_Obj *CONST objv[]);
static int    glArcToArea(Tk_Canvas canvas,Tk_Item *itemPtr,double *rectPtr);
static double glArcToPoint(Tk_Canvas canvas,Tk_Item *itemPtr,double *coordPtr);
static int    glArcToPostscript(Tcl_Interp *interp,Tk_Canvas canvas,Tk_Item *itemPtr,int prepass);
static void   glScaleArc(Tk_Canvas canvas,Tk_Item *itemPtr,double originX,double originY,double scaleX,double scaleY);
static void   glTranslateArc(Tk_Canvas canvas,Tk_Item *itemPtr,double deltaX,double deltaY);
static int    AngleInRange(double x,double y,double start,double extent);
static void   glComputeArcOutline(Tk_Canvas canvas,glArcItem *arcPtr);
static int    HorizLineToArc(double x1,double x2,double y,double rx,double ry,double start,double extent);
static int    VertLineToArc(double x,double y1,double y2,double rx,double ry,double start,double extent);
   ...
   Tcl_Obj *const objv[]) /* Arguments describing arc. */
{
   ...
   */
   ...
   arcPtr->activeFillStipple       = NULL;
   arcPtr->disabledFillStipple     = NULL;
   ...
   */
   ...
   if (glArcCoords(interp, canvas, itemPtr, i, objv) != TCL_OK) {
      goto error;
   }
   if (glConfigureArc(interp, canvas, itemPtr, objc-i, objv+i, 0) == TCL_OK) {
      return TCL_OK;
   }
...
static void glComputeArcOutline(
...
static const char *StylePrintProc(
